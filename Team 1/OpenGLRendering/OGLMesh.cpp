...
OGLMesh* OGLMesh::GenerateSmallQuadWithIndices() {
	OGLMesh* m = new OGLMesh();

	std::vector<Vector3> vertices;
	vertices.push_back({ 0.75,-0.95,0 });
	vertices.push_back({ 0.75,-0.75,0 });
	vertices.push_back({ 0.95,-0.95,0 });
	vertices.push_back({ 0.95,-0.75,0 });
	m->SetVertexPositions(vertices);
