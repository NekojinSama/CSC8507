...
PS4Mesh* PS4Mesh::GenerateQuad() {
	...
	mesh->SetVertexPositions({ Vector3(-1,-1,0), Vector3(-1,1,0), Vector3(1,-1,0), Vector3(1,1,0)});
	mesh->SetVertexNormals({ Vector3(0,0,1), Vector3(0,0,1), Vector3(0,0,1), Vector3(0,0,1) });
	mesh->SetVertexTangents({ Vector3(1,0,0), Vector3(1,0,0), Vector3(1,0,0), Vector3(1,0,0) });
	mesh->SetVertexIndices({ 0,1,2,3 });
...
void PS4Mesh::SubmitDraw(
	Gnmx::GnmxGfxContext & cmdList, Gnm::ShaderStage stage) {
