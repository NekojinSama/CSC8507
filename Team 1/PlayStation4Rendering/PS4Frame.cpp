...
PS4Frame::PS4Frame() {
	...
	const uint32_t cueHeapSize =
	Gnmx::ConstantUpdateEngine::computeHeapSize(kNumRingEntries);
	...
	Gnm::registerResource(nullptr, ownerHandle, drawCommandBuffer,	bufferBytes, "FrameDrawCommandBuffer", Gnm::kResourceTypeDrawCommandBufferBaseAddress, 0);
	Gnm::registerResource(nullptr, ownerHandle, constantUpdateEngine, bufferBytes, "FrameConstantUpdateEngine", Gnm::kResourceTypeDrawCommandBufferBaseAddress, 0);
	Gnm::registerResource(nullptr, ownerHandle, constantCommandBuffer,	bufferBytes, "FrameConstantCommandBuffer", Gnm::kResourceTypeDrawCommandBufferBaseAddress, 0);
}
